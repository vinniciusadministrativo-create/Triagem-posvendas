...
export default function DanfeMirror({ nf: nfRaw, chamado }) {
  ...
  return (
    <div className="danfe-container" style={{ marginTop: 20 }}>
      ...
      <div id="danfe-print" style={{ background: "#fff", padding: "8mm", color: "#000", fontFamily: "Arial, sans-serif", position: "relative", width: "210mm", minHeight: "297mm", boxSizing: "border-box", margin: "0 auto", border: "1px solid #000" }}>
